...
- [x] E.7.1 内容模板库：`content_templates` 表 + CRUD API（行业、平台、文案/文生图模板）
- [x] E.7.2 发布向导 Step1 可选「从模板创建」

### 前端专家

- [x] E.7.3 「内容模板」管理页（分类、预览、启用/停用）
- [x] E.7.4 工作台增加按平台/状态的任务趋势简图（现有统计 API 扩展）

### 文档与验证

- [x] E.7.5 茶叶/电商等 1～2 个示例模板种子数据
- [x] E.7.6 明确「平台播放/转化数据」仍为 Out of Scope，写入 `proposal.md` Non-Goals
